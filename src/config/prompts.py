...
The response should strictly be a JSON object containing only the duration in seconds, formatted as and should not include any additional text or information:
